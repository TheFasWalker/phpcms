...
<main class="p-4 md:ml-64 h-auto pt-20" style="height:100vh">
    ...
    <?php else: ?>
        ...
        <h2 class=" text-xl text-red-500">Упс !!!</h2>
        <h2 class=" pb-5 text-xl "> Вы не авторизованы- можете только смотреть все задачи</h2>
        </div>
       
    <?php endif; ?>
    <?php if (count($tasksList) >=1): ?>
                        ...
                        foreach ($tasksList as $task): ?>
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            href="/?controller=todolist&deleteTask=<?= $task['id']?>"
                                            >delete
                                            </a>
                                        </td>
                                    </tr>
    ...
    <?php else: ?>
        <div class=" flex flex-col mx-auto w-fit  items-center  ">
            <h1 class="text-xl ">Что то пошло не так </h1>
            <span class=" font-bold text-xl">Или еще нет ни одной задачи</span>
        </div>
        <?php endif;    ?>
</main>
